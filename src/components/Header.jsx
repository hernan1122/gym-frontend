...
function Header() {
  ...
  return (
    <>
      ...
      <div className='w-40 h-40 absolute top-24 left-12 rounded-lg transform rotate-45 bg-yellow-500'></div>
      <img className='logo-app w-28 absolute' src={logoApp1} alt="Logo de la app" />
